...
class ProgramaPrincipal:
    def __init__(self):
        ...
        self.frames_superior = tk.Frame(self.label_frame_principal, bg='#A9A9A9')
        ...
        self.frames_central = tk.Frame(self.label_frame_principal, bg='#C0C0C0')
        ...
        self.label_ext_cat.config(text='Categoria', bg='#C0C0C0')
        ...
        self.lbl_ext_selec.config(text=f'Escolha uma extensão para busca', bg='#C0C0C0')
        ...
        self.lbl_info_real_time.config(text='Arquivos encontrados: ', bg='#C0C0C0')
        ...
        self.frames_inferior = tk.Frame(self.label_frame_principal, bg='#D3D3D3')
